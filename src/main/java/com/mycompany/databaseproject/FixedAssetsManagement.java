 ...
 * @author ACER
 */
public class FixedAssetsManagement extends javax.swing.JFrame {

    /**
     * Creates new form FixedAssetsManagement
     */
    public FixedAssetsManagement() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FixedAssetsManagement.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FixedAssetsManagement().setVisible(true);
            }
        });
    }
